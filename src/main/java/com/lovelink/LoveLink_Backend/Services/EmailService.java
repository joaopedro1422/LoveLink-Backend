...
public class EmailService {
    ...
    public void enviarRegistroPagina(Pagina pagina){
        try {
            ...
            String url = "http://192.168.0.140:4200/"+pagina.getSlug()+"/" + pagina.getId();
            String conteudoHtml = """
                    <!DOCTYPE html>
                    <html>
                             <head>
                             ...
                             <body>
                               <div class="container">
                                 ...
                                 <div class="codigo">
                                   <p>http://192.168.0.140:4200/%s/%s</p>
                                 </div>
                           
                                 <a href="http://192.168.0.140:4200/qrCode/%s/%s" class="btn" target="_blank" rel="noopener noreferrer">Gerar QR Code</a>
            ...
            byte[] qrCodeBytes = gerarQrCode(url, 280, 280);
            ByteArrayDataSource qrDataSource = new ByteArrayDataSource(qrCodeBytes, "image/png");
            helper.addAttachment("qrcode.png", qrDataSource);
